...
use GridyAPI\Client\Model\ModelInterface;
...
class ObjectSerializer
{
     ...
     * @param string $type   the GridyAPIToolsType of the data
     * @param string $format the format of the GridyAPITools type of the data
     *
    ...
    public static function sanitizeForSerialization($data, $type = null, $format = null)
    {
        ...
        echo 'sanitizeForSerialization -> called';
    ...
    /**
     * Checks if a value is empty, based on its GridyAPI type.
     *
     * @param mixed  $value
     ...
     * @param string $openApiType GridyAPIType eg. array or object
    ...
    public static function toQueryValue(
        ...
        #  - its value is set to a value that is equivalent to "empty", depending on its GridyAPI type. For
        ...
        // https://github.com/OAI/GridyAPI-Specification/blob/main/versions/3.1.0.md#style-values
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\GridyAPI\Client\Model\\' . $data->{$discriminator};
