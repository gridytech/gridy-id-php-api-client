...
class ApiRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiRequest';
     ...
     * @return boolean[]
     */
    private function getGridyAPINullablesSetToNull(): array
    {
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['api_user'] === null) {
            $invalidProperties[] = "'api_user' can't be null";
        }
     ...
     * Sets api_user
     *
     * @param string $api_user api_user
     *
     * @return self
     */
